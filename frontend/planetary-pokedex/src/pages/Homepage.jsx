    ...
    <div className="min-h-screen relative overflow-hidden bg-black text-red-500 flex flex-col">
      ...
      <main className="relative z-10 flex flex-col items-center justify-center flex-grow">
        ...
        <div className="w-full max-w-7xl px-4 mb-4">
          <Link 
            to="/" 
            className="inline-flex items-center text-blue-500 hover:text-blue-400 mt-8 transition-colors duration-200"
          >
      ...
      <footer className="relative z-10 bg-gray-900 text-gray-400 py-4 mt-8">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="mt-2 flex justify-center space-x-4">
            <Link to="/" className="text-blue-500 hover:text-red-400 transition-colors duration-200">Home</Link>
            <span className="text-gray-600">|</span>
            <a href="#" className="text-blue-500 hover:text-red-400 transition-colors duration-200">About</a>
            <span className="text-gray-600">|</span>
            <a href="#" className="text-blue-500 hover:text-red-400 transition-colors duration-200">Contact</a>
          </div>
        </div>
      </footer>
    </div>
